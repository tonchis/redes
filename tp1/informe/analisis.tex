...
\indent Los grafos presentados a continuación muestran direcciones IP como nodos unidos por un eje si el nodo origen realizó un broadcast ARP who-has buscando al nodo destino (el peso de estos ejes representa la cantidad de mensajes enviados).\\
